...
sounds interesting](https://github.com/cluster-api-provider-hcloud/cluster-api-provider-hcloud/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).
...
[cluster-api-provider-hcloud organization](https://github.com/cluster-api-provider-hcloud) GitHub organization.
