...
func (s *Service) provisionMachine(ctx context.Context, server models.Server) error {
	...
	fmt.Println("Run block device command")
...
EOF`,
	...
	*/
	...
	fmt.Println("Create nocloud directory")
