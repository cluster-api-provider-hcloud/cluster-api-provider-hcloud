...
STABLE_DOCKER_REGISTRY ${KUBE_DOCKER_REGISTRY:-docker.io/simonswine}
STABLE_DOCKER_PUSH_REGISTRY ${KUBE_DOCKER_PUSH_REGISTRY:-${KUBE_DOCKER_REGISTRY:-docker.io/simonswine}}
