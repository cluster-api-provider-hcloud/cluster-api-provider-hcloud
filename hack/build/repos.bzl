...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:T2eOj/NKN1Q1W1bD9MFeZiBYryS0JlWT6aROAvVWFSs=",
        version = "v1.0.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:8x49nBRxuXGUlDlwlWd3RMY1SayZrzFfxea3UZSkFw4=",
        version = "v0.18.4",
    )
    go_repository(
        ...
        sum = "h1:Y3HGERmS8t9u12YNUFoOISqefaoGRuTc43AYCLzWmWE=",
        version = "v0.18.4",
    )
    go_repository(
        ...
        sum = "h1:ST2beySjhqwJoIFk6p7Hp5v5O0hYY6Gngq/gUYXTPIA=",
        version = "v0.18.4",
    )
    go_repository(
        ...
        sum = "h1:pn1jSQkfboPSirZopkVpEdLW4FcQLnYMaIY8LFxxj30=",
        version = "v0.18.4",
    )
    go_repository(
        ...
        sum = "h1:un55V1Q/B3JO3A76eS0kUSywgGK/WR3BQ8fHQjNa6Zc=",
        version = "v0.18.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:SouAMfh3jbL7aL8rnUQ/C+7WwXYTZnPa8L9V2TtIE7o=",
        version = "v0.18.4",
    )
    go_repository(
        ...
        sum = "h1:Kr53Fp1iCGNsl9Uv4VcRvLy7YyIqi9oaJOQ7SXtKI98=",
        version = "v0.18.4",
    )
    go_repository(
        name = "io_k8s_gengo",
    ...
    go_repository(
        ...
        sum = "h1:YYaAzXP+bHzqIQTJoJXMIT4QN4MjIep9NnxwBDPjiD8=",
        version = "v0.3.8",
    )
    go_repository(
        ...
        sum = "h1:LcK2+nk0kmaOnKGN+vBcWHqY5WDJNJNB/c5pW+sU8fc=",
        version = "v0.6.1",
    )
    go_repository(
