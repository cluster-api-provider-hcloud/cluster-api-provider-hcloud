...
dnf install --setopt=obsoletes=0 -y kubelet-0:1.19.0-0 kubeadm-0:1.19.0-0 kubectl-0:1.19.0-0 python3-dnf-plugin-versionlock bash-completion --disableexcludes=kubernetes
