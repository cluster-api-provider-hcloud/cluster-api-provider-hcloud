...
// adapted from:
// https://raw.githubusercontent.com/kubernetes/kubelet/cca5df04fb0f832080e7f0acfe2390c53970716f/config/v1beta1/types.go
...
func init() {
	SchemeBuilder.Register(&KubeletConfiguration{})
}
