...
// +kubebuilder:webhook:verbs=create;update,path=/validate-cluster-api-provider-hcloud-capihc-com-v1alpha4-baremetalmachine,mutating=false,failurePolicy=fail,matchPolicy=Equivalent,groups=cluster-api-provider-hcloud.capihc.com,resources=baremetalmachines,versions=v1alpha4,name=validation.baremetalmachine.cluster-api-provider-hcloud.capihc.com
