...
func (in *HcloudClusterSpec) DeepCopyInto(out *HcloudClusterSpec) {
	*out = *in
	...
	if in.ControlPlaneFloatingIPs != nil {
		...
		*out = make([]HcloudFloatingIPSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Manifests != nil {
		...
		*out = new(HcloudClusterSpecManifests)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HcloudClusterSpecManifests) DeepCopyInto(out *HcloudClusterSpecManifests) {
	*out = *in
	if in.Disabled != nil {
	...
	if in.Network != nil {
		in, out := &in.Network, &out.Network
		*out = new(HcloudClusterSpecManifestsNetwork)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HcloudClusterSpecManifests.
func (in *HcloudClusterSpecManifests) DeepCopy() *HcloudClusterSpecManifests {
	if in == nil {
		return nil
	}
	out := new(HcloudClusterSpecManifests)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HcloudClusterSpecManifestsNetwork) DeepCopyInto(out *HcloudClusterSpecManifestsNetwork) {
	*out = *in
	if in.Calico != nil {
		in, out := &in.Calico, &out.Calico
		*out = new(HcloudClusterSpecManifestsNetworkCalico)
		**out = **in
	}
	if in.Cilium != nil {
		in, out := &in.Cilium, &out.Cilium
		*out = new(HcloudClusterSpecManifestsNetworkCilium)
		(*in).DeepCopyInto(*out)
	}
	if in.Flannel != nil {
		in, out := &in.Flannel, &out.Flannel
		*out = new(HcloudClusterSpecManifestsNetworkFlannel)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HcloudClusterSpecManifestsNetwork.
func (in *HcloudClusterSpecManifestsNetwork) DeepCopy() *HcloudClusterSpecManifestsNetwork {
	if in == nil {
		return nil
	}
	out := new(HcloudClusterSpecManifestsNetwork)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HcloudClusterSpecManifestsNetworkCalico) DeepCopyInto(out *HcloudClusterSpecManifestsNetworkCalico) {
	*out = *in
}
...
func (in *HcloudClusterSpecManifestsNetworkCalico) DeepCopy() *HcloudClusterSpecManifestsNetworkCalico {
	if in == nil {
		return nil
	}
	out := new(HcloudClusterSpecManifestsNetworkCalico)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HcloudClusterSpecManifestsNetworkCilium) DeepCopyInto(out *HcloudClusterSpecManifestsNetworkCilium) {
	*out = *in
	if in.IPSecKeysRef != nil {
		in, out := &in.IPSecKeysRef, &out.IPSecKeysRef
		*out = new(v1.SecretKeySelector)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *HcloudClusterSpecManifestsNetworkCilium) DeepCopy() *HcloudClusterSpecManifestsNetworkCilium {
	if in == nil {
		return nil
	}
	out := new(HcloudClusterSpecManifestsNetworkCilium)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HcloudClusterSpecManifestsNetworkFlannel) DeepCopyInto(out *HcloudClusterSpecManifestsNetworkFlannel) {
	*out = *in
}
...
func (in *HcloudClusterSpecManifestsNetworkFlannel) DeepCopy() *HcloudClusterSpecManifestsNetworkFlannel {
	if in == nil {
		return nil
	}
	out := new(HcloudClusterSpecManifestsNetworkFlannel)
...
func (in *HcloudClusterStatus) DeepCopyInto(out *HcloudClusterStatus) {
	*out = *in
	...
	if in.ControlPlaneFloatingIPs != nil {
		in, out := &in.ControlPlaneFloatingIPs, &out.ControlPlaneFloatingIPs
		*out = make([]HcloudFloatingIPStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
